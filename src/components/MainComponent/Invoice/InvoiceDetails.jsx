  ...
  return (
    <>
      <div id="invoice-buyer" className="invoice-init-values">
        ...
        <div class="row mb-2">
          <label for="invoice-buyer-details" class="col-sm-2 col-form-label-sm">
            Company
          </label>
          <div class="col-sm-6">
            <input
              type="text"
              class="form-control-sm border border-0"
              placeholder="company"
              name="buyercompany"
        ...
        <div class="row mb-2">
          <label for="invoice-buyer-details">
      ...
      <div id="invoice-seller" className="invoice-init-values">
        ...
        <div class="row mb-2">
          <label for="invoice-seller-details">
            Electronic&nbsp;Address&nbsp;Scheme
          </label>
          <div class="col-sm-5 border border-0">
            <select
